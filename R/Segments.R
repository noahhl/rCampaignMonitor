...
GetSegmentMembers <- function(segment, since="2000-01-01", limit="ALL", order_by="email", order_dir="asc", format="json", api_key) {
...
GetSegmentInfo <- function(segment, format="json", api_key) {
